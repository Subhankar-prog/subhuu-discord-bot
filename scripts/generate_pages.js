...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-item { color: var(--text); font-size: 15px; font-weight: 600; padding: 8px 16px; border-radius: 8px; display: flex; align-items: center; gap: 6px; cursor: pointer; }
    .nav-item:hover { background: rgba(255,255,255,0.08); }
    .chevron-down { font-size: 10px; opacity: 0.7; }
    .nav-actions { display: flex; align-items: center; gap: 12px; margin-left: auto; }
    .btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 8px 16px; border-radius: 8px; font-size: 14px; font-weight: 600; border: none; cursor: pointer; }
    .btn-primary { background: var(--accent); color: white; }
    .premium-badge { background: rgba(255, 195, 79, 0.14); color: #FFC34F; padding: 8px 16px; border-radius: 8px; font-size: 15px; font-weight: 700; }
    ...
    .dropdown-item { padding: 12px 20px; color: var(--text-light); font-size: 15px; font-weight: 500; display: flex; align-items: center; gap: 12px; }
    .dropdown-item:hover { background: rgba(255,255,255,0.05); color: var(--text); }

    /* CONTENT */
    .page-content { flex: 1; max-width: 900px; margin: 0 auto; padding: 100px 32px; text-align: center; }
    .page-icon { font-size: 80px; margin-bottom: 20px; }
    .page-title { font-size: 48px; font-weight: 800; margin-bottom: 24px; letter-spacing: -1px; }
    .page-desc { font-size: 20px; color: var(--text-muted); line-height: 1.6; margin-bottom: 60px; }
    
    .placeholder-box { background: var(--bg-card); border: 1px dashed var(--border); border-radius: 16px; padding: 60px 40px; color: var(--text-muted); font-size: 16px; font-weight: 500; }

    /* FOOTER */
    footer { background: var(--bg-card); border-top: 1px solid var(--border); padding: 80px 32px 60px; }
    .footer-inner { max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 300px 1fr 1fr 1fr; gap: 40px; }
    ...
    .footer-col a { display: block; font-size: 15px; color: var(--text-muted); margin-bottom: 12px; font-weight: 500; }
